        ...
        cameraBtn.addEventListener('click', async () => {
            try {
                ...
                modal.style.cssText = `
                    ...
                    gap:20px;
                `;
                video.style.cssText = `max-width:90%; max-height:70vh; border-radius:16px;`;

                const captureBtn = document.createElement('button');
                captureBtn.textContent = 'Capture';
                captureBtn.className = 'btn-primary';
                captureBtn.style.cssText = 'padding:1rem 3rem; font-size:1.125rem;';

                const closeBtn = document.createElement('button');
                closeBtn.textContent = 'Cancel';
                closeBtn.className = 'btn-secondary';
                closeBtn.style.cssText = 'padding:1rem 3rem; font-size:1.125rem;';
